...
[^hypoth03]: Bickel and Doksum \cite{Bickel2001} state the
...
Table: Hypothesis tests, difference in population proportions, large sample]: Hypothesis tests, difference in population proportions, large sample.
